...
public class DirectiveFactory {
    ...
    public static Individual createGeneralDirective(OntModel model, Context context, String name, int line_num) {
    ...
    public static Individual createUse(OntModel model, Context context, int line_num, String args,String macroURI) {
        Individual use = createRule(model, context, line_num, "Use", args, OntCWAF.USE);
        use.addLiteral(OntCWAF.USE_MACRO, macroURI);
        return use;
    }

    public static Individual createModSecRule(OntModel model, Context context, int line_num, String name, String args, int phase) {
    ...
    public static Individual createInclude(OntModel model, Context context, String name, int line_num, Individual parsedFile) {
    ...
    public static Individual createDirective(OntModel model, Context context, int line_num, String name, OntClass type) {
    ...
    public static Individual createDirective(OntModel model, Context context, int line_num, String name) {
        return createDirective(model, context, line_num, name, OntCWAF.DIRECTIVE);
    }

    private static void initDirective(OntModel model, Context context, int line_num, String URI, Individual directiveInd) {
    ...
    public static Individual createRule(OntModel model, Context context, int line_num, String name, String args) {
        return createRule(model, context, line_num, name, args, OntCWAF.RULE);
    }

    public static Individual createRule(OntModel model, Context context, int line_num, String name, String args, OntClass type) {
    ...
    public static Individual createBeacon(OntModel model, Context context, int line_num, String name, OntClass type) {
        return createDirective(model, context, line_num, name, type);
    }

    public static Individual createBeacon(OntModel model, Context context, int line_num, String name) {
        return createDirective(model, context, line_num, name, OntCWAF.BEACON);
    }

    public static Individual createMacro(OntModel model, Context context, int line_num, String name) {
    ...
    public static Individual createIf(OntModel model, Context context, int line_num, String condition) {
